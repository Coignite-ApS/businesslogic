-- Migration 031: Replace public.aggregate_usage_events() with three fixes:
--   C1: Remove calc_unique_calculators (not additively decomposable; column kept, left NULL)
--   I1: Add pg_advisory_xact_lock to prevent concurrent double-count
--   I4: Safe-cast metadata->>'input_tokens' / output_tokens to prevent crash on malformed data
