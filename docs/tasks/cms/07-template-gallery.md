...
Public Gallery (static site or Directus-served page)
  ...
  │     ├── Live calculator widget (#04) with pre-filled defaults
...
- Include a `widget_layout` (once #04 ships) for the gallery demo
...
- [ ] Each template has a live, interactive demo using the widget (#04)
...
- **#04a (Core Widget)** — gallery demos use the embeddable widget
