# 10. Lead Capture & CRM Integration
...
- The widget (#07) will render calculators, but has no conversion layer
...
### Widget Integration (render library #07)
...
- **#07a (Core Widget)** — the widget must exist to add the lead gate layer
