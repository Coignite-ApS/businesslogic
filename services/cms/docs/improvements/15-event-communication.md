# 15. Event-Driven Communication & Client Data

**Status:** planned
**Phase:** 2 — Go-to-Market
**Depends on:** #14 (Pricing) for subscription events
...
| **Lead** | `lead.captured` | Lead capture endpoint (#10) | {calculator_id, email, fields} |
...
17. **Webhook triggers** — alongside email, fire webhooks on events (extends #10 Lead Capture)
...
- **#14 (Pricing)** — usage limits must exist to trigger usage warnings
- **#05 (Admin Dashboard)** — event log + data export UI lives here
- **#10 (Lead Capture)** — `lead.captured` event
