...
**This command MUST use Opus.** The CTO review agent requires Opus-level reasoning for architecture evaluation, security analysis, and quality judgment. When spawning the sub-agent, always specify `model: "opus"`.
